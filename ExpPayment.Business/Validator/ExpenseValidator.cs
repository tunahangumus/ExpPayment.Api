...
public class CreateExpenseValidator : AbstractValidator<ExpenseRequest>
{
	public CreateExpenseValidator()
	{
		...
		RuleFor(x => x.Date).NotEmpty().InclusiveBetween(DateTime.UtcNow.Date.AddMonths(-4), DateTime.UtcNow.Date).WithMessage("You can enter expenses from a maximum of 4 months ago.");
